...
//
//     final cardMode = cardModeFromJson(jsonString);
...
class CardModel {
  ...
  factory CardModel.fromJson(Map<String, dynamic> json) => CardModel(
        ...
        isPrice: json["is_price"] == null ? null : json["is_price"]!,
        createAt: json["create_at"] == null
            ? null
            : DateTime.parse(json["create_at"]),
        user: json["user"] == null ? null : User.fromJson(json["user"]),
        herbalTea: json["herbal_tea"] == null
            ? null
            : HerbalTea.fromJson(json["herbal_tea"]),
      );

  Map<String, dynamic> toJson() => {
        "id": id == null ? null : id!,
        "count": count == null ? null : count!,
        "is_price": isPrice == null ? null : isPrice!,
        "create_at": createAt == null ? null : createAt!.toIso8601String(),
        "user": user == null ? null : user!.toJson(),
        "herbal_tea": herbalTea == null ? null : herbalTea!.toJson(),
      };
}
...
class HerbalTea {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "description_zarar":
            descriptionZarar == null ? null : descriptionZarar!,
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        isSuperuser:
            json["is_superuser"] == null ? null : json["is_superuser"]!,
        ...
        phone:
            json["phone"] == null ? null : utf8.decode(json["phone"].codeUnits),
